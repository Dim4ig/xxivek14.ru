...
<head>
	<meta charset="utf-8">
	<title>Программа повышения квалификации - Противодействие коррупции</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Программа повышения квалификации "Противодействие коррупции"<br>
			</div><br>
			<div id="content-container-left">
                ...
                <div id="content-container-left-inner">
					...
					<ul id="courses-menu">
                    	<li class="selected-courses-menu-elem"><a href="advanced-training-protivodeistvie_korrupcii.php">Противодействие коррупции</a></li>
			...
			<div id="content-container-info" align="center">
				<h2>Противодействие коррупции</h2><br>
				<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Российское законодательство</b> требует принятия в органах государственной власти и органах местного самоуправления, в государственных и муниципальных учреждениях мер по предупреждению и противодействию коррупции. Данные меры включают в себя целый комплекс мероприятий, начиная от формирования соответствующей нормативно-правовой базы и заканчивая обучением требованиям антикоррупционного законодательства.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Данный курс включает</b> изучение основ антикоррупционного законодательства, принципов противодействия коррупции в государственных и муниципальных органах Российской федерации. Вы узнаете все о правах и обязанностях государственных и муниципальных служащих, работников контрактной службы и членов закупочных комиссий, а также об ответственности за коррупционные действия.</p><br>
				<img src="source/images/courses/protivodeistvie_korrupcii.jpg" width="auto" height="700px">
			</div>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Противодействие коррупции"</option>
