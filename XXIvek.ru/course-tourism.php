	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Курс "Туризм"<br>
			</div><br>
			<div id="content-container-left">
				<div id="content-container-left-inner">
					...
					<ul id="courses-menu">
        	            ...
        	            <li class="selected-courses-menu-elem"><a href="course-tourism.php">Туризм</a></li>
			...
			<div id="content-container-info" align="center">
				<h2>Туризм</h2><br>
				<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Целью программы является</b> развитие профессиональных компетенций в части разработки инвестиционных проектов комплексного развития туристских кластеров территорий, направленного на повышение качества туристских услуг в субъектах Российской Федерации, у сотрудников образовательных учреждений туристского профиля, государственных и муниципальных служащих сферы туризма субъектов Российской Федерации, предпринимателей и менеждеров индустрии туризма и гостеприимства.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Специалисты в области туризма</b> – это одна из популярнейших профессий у гуманитариев. Люди этой профессии занимаются решением самых разных проблем, связанных с организацией отдыха. Работа в области туризма очень интересна и способна приносить не только хорошие деньги, но и моральное удовлетворение.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Чтобы стать специалистом</b>, необходимо иметь множество различных навыков, а также иметь документы, подтверждающие профессионализм. Так, специалист, работающий в сфере туризма, должен знать иностранный язык, иметь хорошую память, знать как можно больше сведений о курорте, отелях, возможных экскурсиях, уметь находить общий язык с каждым клиентом. Иногда возникают правовые споры, их так же должен уметь решать сотрудник туристической компании.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;У нас есть <b>дистанционное обучение</b> для занятых, а также можно организовать <b>очные</b> курсы.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Длительность обучения</b> – 16 академических часов. По результатам слушателям будут выданы удостоверения о повышении квалификации установленного образца. </p><br>
				<img src="source/images/courses/tourism.jpg" width="auto" height="450px;">
			</div>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Туризм"</option>
