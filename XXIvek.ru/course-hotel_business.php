...
<head>
	<meta charset="utf-8">
	<title>Курс - Гостиничное дело</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Курс "Гостиничное дело"<br>
			</div><br>
			<div id="content-container-left">
				<div id="content-container-left-inner">
					...
					<ul id="courses-menu">
            	        ...
            	        <li class="selected-courses-menu-elem"><a href="course-hotel_business.php" class="courses-menu-last-elem">Гостиничное дело</a></li>
                	</ul>
                </div><br>
                <div id="content-container-left-inner">
			...
			<div id="content-container-info" align="center">
				<h2>Гостиничное дело</h2><br>
				<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Профессия в сфере гостиничного бизнеса</b> – перспективно и актуально.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Содержание Программы</b> охватывает круг вопросов и проблем, связанных с теоретическими основами менеджмента, а также менеджмента на предприятиях гостиничного хозяйства. Дополнительная профессиональная программа повышения квалификации «Гостиничное дело» рассчитан на слушателей, желающих приобрести дополнительные знания, необходимые для выполнения нового вида профессиональной деятельности. По результатам слушатели получают удостоверение установленного образца, удостоверяющий их право  вести профессиональную деятельность в сфере гостиничного бизнеса. Программой предусматривается изучение теоретических и практических основ гостиничного бизнеса. Программа для персонала гостиниц и туристических организаций.<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Длительность обучения</b> – 16 академических часов. По результатам слушателям будут выданы удостоверения о повышении квалификации установленного образца.</p><br><br>
				<img src="source/images/courses/hotel_business.png" width="auto" height="620px">
			</div>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Гостиничное дело"</option>
						<option disabled="true">-------------------------------------</option>
