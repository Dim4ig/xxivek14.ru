...
<head>
	<meta charset="utf-8">
	<title>Программа профессиональной переподготовки - Управление персоналом</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Программа профессиональной переподготовки "Управление персоналом"<br>
			</div><br>
			<div id="content-container-left">
                ...
                <div id="content-container-left-inner">
					...
					<ul id="courses-menu">
        	            ...
        	            <li class="selected-courses-menu-elem"><a href="professional-retraining-upravlenie_personalom.php">Управление персоналом</a></li>
			...
			<div id="content-container-info" align="center">
				<h2>Управление персоналом</h2><br>
			 	<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Дополнительная <b>профессиональная программа профессиональной переподготовки</b> «Управление персоналом» является важным элементом формирования у специалистов системы знаний в области управления человеческими ресурсами предприятия. Она обеспечивает обязательный минимум знаний для профессиональной деятельности менеджеров, способных вести хозяйство в условиях кризиса и обеспечивать рациональное использование имеющихся возможностей предприятия. Любая сфера бизнеса нуждается в грамотном управлении - менеджменте.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;Дополнительная <b>профессиональная программа профессиональной переподготовки</b> рассчитана на слушателей, желающих приобрести дополнительные знания, необходимые для выполнения нового вида профессиональной деятельности.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Программа ориентирована на</b> слушателей, желающих работать в кадровой службе, менеджером по персоналу.</p><br><br>
				<img src="source/images/courses/upravlenie_personalom.jpg" width="900px" height="auto">
			</div>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Управление персоналом"</option>
