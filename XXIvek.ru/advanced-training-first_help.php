...
<head>
	<meta charset="utf-8">
	<title>Программа повышения квалификации - Оказание первой медицинской помощи</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Программа повышения квалификации "Оказание первой медицинской помощи"<br>
			</div><br>
			<div id="content-container-left">
                ...
                <div id="content-container-left-inner">
					...
					<ul id="courses-menu">
        	            ...
        	            <li class="selected-courses-menu-elem"><a href="advanced-training-first_help.php">Оказание первой медицинской помощи</a></li>
			...
			<div id="content-container-info">
				<h2>Оказание первой медицинской помощи</h2><br>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Оказание первой медицинской помощи"</option>
						<option>"Охрана труда"</option>
