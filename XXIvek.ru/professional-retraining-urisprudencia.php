...
<head>
	<meta charset="utf-8">
	<title>Программа профессиональной переподготовки - Юриспруденция</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Программа профессиональной переподготовки "Юриспруденция"<br>
			</div><br>
			<div id="content-container-left">
                ...
                <div id="content-container-left-inner">
					...
					<ul id="courses-menu">
            	        ...
            	        <li class="selected-courses-menu-elem"><a href="professional-retraining-urisprudencia.php">Юриспруденция</a></li>
			...
			<div id="content-container-info" align="center">
				<h2>Юриспруденция</h2><br>
			 	<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Программа профессиональной переподготовки</b> «Юриспруденция» включает в себя объем информации для получения полного объема знаний, навыков и компетенций для применения на практике в рабочей деятельности. Это позволит Вам уверенно работать в новой профессии.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;Центр дополнительного образования <b>предоставляет услуги</b> по обучению в рамках программы профессиональной переподготовки «Юриспруденция». Программа рассчитана на специалистов, уже имеющих среднее профессиональное или высшее образование и желающих освоить новое направление, получив профессию юриста. Обучение предполагает присвоение квалификации «юрист».</p><br><br>
				<img src="source/images/courses/urisprudencia.jpg" width="930px" height="auto">
			</div>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Юриспруденция"</option>
