...
<head>
	<meta charset="utf-8">
	<title>Программа профессиональной переподготовки - Правоохранительная деятельность</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Программа профессиональной переподготовки "Правоохранительная деятельность"<br>
			</div><br>
			<div id="content-container-left">
                ...
                <div id="content-container-left-inner">
					...
					<ul id="courses-menu">
                	    ...
                	    <li class="selected-courses-menu-elem"><a href="professional-retraining-pravoohranitelnaya_deyatelnost.php" class="courses-menu-last-elem">Правоохранительная деятельность</a></li>
                	</ul>
                </div>
			</div>

			<div id="content-container-info" align="center">
				<h2>Правоохранительная деятельность</h2><br>
			 	<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Программа профессиональной переподготовки «Правоохранительная деятельность»</b> разработана с учетом требований рынка труда и направлена на получение компетенции, необходимой для выполнения нового вида профессиональной деятельности слушателей на развитие профессиональной компетентности обучающихся посредством освоения им знаний, навыков и умений в области основ административного права, предмете и методе административно-правового регулирования,  необходимых для грамотного решения практических задач.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Цель образовательной программы:</b> подготовка квалифицированных кадров в сфере деятельности правоохранительных органов. <br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Целевая аудитория:</b> специалисты с высшим и средним профессиональным образованием, лица, обучающиеся по программам среднего или высшего профессионального образования. <br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;В результате обучения Вы получаете диплом о профессиональной переподготовке установленного образца: Квалификация «Правоохранительная деятельность»; специальность «Юрист».<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Срок обучения:</b> 5-6 месяцев, 540 часов <br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Стоимость обучения:</b> 20 000руб. </p><br><br>
				<img src="source/images/courses/pravoohranitelnaya_deyatelnost.png" width="auto" height="485px">
			</div><div onclick="show('none')" id="wrap"></div>  
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Правоохранительная деятельность"</option>
					</select><br>
