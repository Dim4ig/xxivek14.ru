	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Курс "Охрана труда"<br>
			</div><br>
			<div id="content-container-left">
				<div id="content-container-left-inner">
					<br><h2 align="center">Наши курсы:</h2><br>
					<ul id="courses-menu">
                    	<li class="selected-courses-menu-elem"><a href="course-ohrana_truda.php" >Охрана труда</a></li>
			...
			<div id="content-container-info" align="center">
				...
				<img src="source/images/courses/ot.jpg" width="auto" height="680px">
			</div>
