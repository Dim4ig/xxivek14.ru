...
<head>
	<meta charset="utf-8">
	<title>Программа повышения квалификации - Пожарная безопасность</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Программа повышения квалификации "Пожарная безопасность"<br>
			</div><br>
			<div id="content-container-left">
                ...
                <div id="content-container-left-inner">
					...
					<ul id="courses-menu">
                	    ...
                	    <li class="selected-courses-menu-elem"><a href="advanced-training-pozharnaya_bezopasnost.php">Пожарная безопасность</a></li>
			...
			<div id="content-container-info" align="center">
				<h2>Пожарная безопасность</h2><br>
			 	<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Пожарно-технический минимум</b> — это основной вид обучения руководителей и работников организаций мерам пожарной безопасности, целью которого является повышение противопожарной культуры работающего населения, овладение приемами и способами действий при возникновении пожара как на производстве, так и в быту, выработка практических навыков по спасению жизни, здоровья и имущества при пожаре.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Учебная программа предназначена для</b> повышения квалификации руководителей и ответственных за пожарную безопасность в учреждениях (офисах).</p><br><br>
				<img src="source/images/courses/pozharnaya_bezopasnost.jpg" width="900px" height="auto">
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option>"Охрана труда"</option>
						<option selected="true">"Пожарная безопасность"</option>
