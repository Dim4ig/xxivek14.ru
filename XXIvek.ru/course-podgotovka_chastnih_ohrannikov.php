...
<head>
	<meta charset="utf-8">
	<title>Курс - Подготовка частных охранников</title>
	...
	<div id="container">
		...
		<div id="content-container">
			<div id="content-container-navigation">
				<br><a href="index.php" class="back_to_main">Главная</a> / Курс "Подготовка частных охранников"<br>
			</div><br>
			<div id="content-container-left">
				<div id="content-container-left-inner">
					...
					<ul id="courses-menu">
                	    ...
                	    <li class="selected-courses-menu-elem"><a href="course-podgotovka_chastnih_ohrannikov.php">Подготовка частных охранников</a></li>
			...
			<div id="content-container-info" align="center">
				<h2>Подготовка  частных охранников</h2><br>
				<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;<b>Программа профессионального обучения</b> направлена на приобретение профессиональной компетенции охранника без изменений уровня образования.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Программа</b> является необходимым условием для получения гражданами правового статуса частного охранника.<br><br>
			 	&nbsp;&nbsp;&nbsp;&nbsp;<b>Срок обучения</b> по программе зависит от присваиваемого квалификационного уровня, который определяется с учетом исполнения частным охранником обязанностей, связанных с использованием оружия и специальных средств.</p><br><br>
				<!--<img src="source/images/courses/podgotovka_chastnih_ohrannikov1.jpg" width="700px" height="auto">-->
				<img src="source/images/courses/podgotovka_chastnih_ohrannikov2.jpg" width="800px" height="auto">
			</div>
			...
			<div id="zayavka">
				<form method="POST" action="zayavka.php">
					...
					<select name="selected_program">
						...
						<option selected="true">"Подготовка частных охранников"</option>
